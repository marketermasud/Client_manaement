    ...
    <div class="mp-card mp-statement">
      <div class="mp-card-body p-4 p-md-5">
        ...
        <table class="table mp-table mb-2" style="font-size:12.5px;">
          <thead><tr><th>Date</th><th>Payment ID</th><th>Amount</th><th>Rate</th><th>BDT Value</th><th>Method</th><th>Status</th><th>Outstanding</th></tr></thead>
          <tbody>
            ...
            }).join("") : `<tr><td colspan="8" class="text-muted-mp">No payments recorded yet.</td></tr>`}
          </tbody>
          <tfoot>
