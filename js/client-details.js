...
function paymentsHtml(c) {
  ...
  return `
    ...
    <div class="mp-scroll-x">
      <table class="table mp-table mb-0">
        <thead><tr><th>Payment ID</th><th>Date</th><th>Amount</th><th>Rate</th><th>BDT Value</th><th>Outstanding</th><th>Method</th><th>Service</th><th>Status</th><th class="text-end">Actions</th></tr></thead>
        <tbody>
          ...
          }).join("") : `<tr><td colspan="10">${MPUI.emptyState("bi-receipt", "No payments yet for this client.")}</td></tr>`}
        </tbody>
      </table>
    </div>`;
}
...
function renderModals(c) {
      ...
      <div class="modal-dialog"><div class="modal-content" style="border-radius:16px;">
        ...
        <div class="modal-body">
          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-6"><label class="form-label">End Date</label><input type="date" class="form-control" id="sv_endDate"></div>
          </div>
      ...
      <div class="modal-dialog modal-dialog-scrollable"><div class="modal-content" style="border-radius:16px;">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <div class="small text-muted-mp mt-1">Currency (from service): <span class="mp-currency-pill" id="pm_currencyLabel">—</span></div>
          </div>
          <div class="row g-3 mb-3">
          ...
          <div class="mb-1"><label class="form-label">Notes</label><textarea class="form-control" id="pm_notes" rows="2"></textarea></div>
  ...
  function pmOnServiceChange() {
    ...
    if (svc) {
      ...
      if (!document.getElementById("pm_paymentId").value) {
        document.getElementById("pm_amount").value = svc.amount || "";
        document.getElementById("pm_totalDue").value = svc.amount || "";
      }
    }
    pmUpdatePreview();
  }
